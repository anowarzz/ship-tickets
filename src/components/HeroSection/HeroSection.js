          ...
          <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="flex flex-col items-center justify-between xl:flex-row">
              <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                <h5 className="max-w-lg mb-6   font-bold tracking-tight text-white sm:text-xl sm:leading-none mt-12">
                  Good Morning
                </h5>
                <h4 className="text-teal-400 text-2xl md:text-4xl font-bold lg:text-5xl mt-4 mb-12">
                  Mr. Donald Trump
                </h4>
                <p className="max-w-xl mb-4 text-base text-white md:text-lg mt-2">
